...
class Tiket{
    ...
    public function UpdateTiketKeluar($tgl_keluar,$id_petugas_keluar,$total_harga,$status){
        try{
            $sql = "UPDATE tiket SET tgl_keluar=:tgl_keluar,id_petugas_keluar=:id_petugas_keluar,total_harga=:total_harga,status=:status
            WHERE id_tiket = :id_tiket";
            $stmt = $this->pdo->prepare($sql);
            $stmt->bindParam(":barcode",$id_tiket);
...
// $tiket->UpdateTiketKeluar(2,"2025-11-19 10:37:00",1,10000,"keluar");
// $tiket->DeleteTiket(3);
