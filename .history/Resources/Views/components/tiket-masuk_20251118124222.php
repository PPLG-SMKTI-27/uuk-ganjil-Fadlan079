...
<select id="id_tarif" disabled>
    <option><?= ucfirst($data_tarif['jenis_kendaraan']) ?> - Rp <?= number_format($data_tarif['harga_flat']) ?></option>
</select>
<input type="hidden" name="id_tarif" value="<?= $data_tarif['id_tarif'] ?>">
