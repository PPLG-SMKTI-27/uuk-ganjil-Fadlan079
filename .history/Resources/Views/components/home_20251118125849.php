...
<?php if($sessionUser): ?>
    ...
    <!-- =================== TABLE TIKET =================== -->
    <div class="mt-10">
        <h2 class="text-2xl font-semibold text-cyan-400 mb-4">Daftar Tiket</h2>
    ...
    <!-- =================== TABLE TRANSAKSI =================== -->
    <div class="mt-10">
        <h2 class="text-2xl font-semibold text-cyan-400 mb-4">Daftar Transaksi</h2>
        <div class="overflow-x-auto bg-slate-800 rounded-xl border border-slate-700">
            <table class="min-w-full divide-y divide-slate-700">
                <thead class="bg-slate-900">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-left text-sm font-medium text-slate-300">Tanggal</th>
                ...
                <tbody class="divide-y divide-slate-700">
                    <?php foreach($listTransaksi as $trx): ?>
                        <tr class="hover:bg-slate-700 transition">
                            ...
                            <td class="px-4 py-2 text-slate-300"><?= $trx['tgl_transaksi'] ?></td>
                ...
                <table class="min-w-full divide-y divide-slate-700">
                    <thead class="bg-slate-900">
                        <tr>
                            ...
                            <th class="px-4 py-2 text-left text-sm font-medium text-slate-300">Nama</th>
                    ...
                    <tbody class="divide-y divide-slate-700">
                        <?php foreach($listUser as $user): ?>
                            <tr class="hover:bg-slate-700 transition">
                                ...
                                <td class="px-4 py-2 text-slate-300"><?= $user['nama'] ?></td>
