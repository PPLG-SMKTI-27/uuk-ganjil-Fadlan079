<?php
require_once __DIR__ . "/../../Models/TarifParkir.php";

$tarifModel = new TarifParkir();
$listTarif = $tarifModel->SelectTarif(); // Ambil semua tarif
?>
...
<body class="bg-slate-900 min-h-screen p-6">
    ...
    <div class="max-w-4xl mx-auto space-y-4">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-cyan-400">Manage Tarif Parkir</h1>
