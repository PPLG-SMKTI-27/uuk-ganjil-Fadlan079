                ...
                <?php if($_SESSION['user']['role'] === 'admin'): ?>
                    ...
                    <li>
                        <a href="?action=manage-tiket" 
                            class="hover:text-cyan-400 transition <?= $current=='manage-tiket' ? 'border-b-2 border-cyan-400 text-cyan-400' : '' ?>">
                            <i class="fa-solid fa-ticket"></i> Manage Tiket
                        </a>
                    </li>

                    <li>
                        <a href="?action=manage-transaksi" 
                            class="hover:text-cyan-400 transition <?= $current=='manage-transaksi' ? 'border-b-2 border-cyan-400 text-cyan-400' : '' ?>">
                            <i class="fa-solid fa-money-bill"></i> Manage Transaksi
                        </a>
                    </li>
