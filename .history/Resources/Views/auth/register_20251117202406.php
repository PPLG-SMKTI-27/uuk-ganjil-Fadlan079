...
<body class="font-sans">
    <form action="?action=store-register" method="post"
        ...
        <input type="text" name="email" id="" placeholder="" class="bg-[var(--accent)] p-2 rounded-xl shadow-lg focus:outline-none focus:ring-2 focus:ring-neutral-900 transition-all duration-300">
