...
<body class="font-sans">
    <form action="?action=store-register" method="post"
        ...
        <div class="col-span-2 flex flex-col">
            ...
            <input type="text" name="nama_lengkap" placeholder="isi dengan nama lengkap" class="bg-blue-100 p-2 rounded-xl shadow-lg focus:outline-none focus:ring-2 focus:ring-neutral-900 transition-all duration-300">
        </div>
        ...
        <span>Sudah punya akun?<a href="?action=login">Login</a></span>
