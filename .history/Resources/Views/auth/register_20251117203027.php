...
<body class="font-sans">
    <form action="?action=store-register" method="post"
        ...
        class="col-span-2 p-2 rounded-xl shadow-lg bg-[var(--accent)] text-[var(--textmain)] font-semibold tracking-wide hover:bg-[var(--primary)] hover:text[var(--accent)] transit">
    </form>
</body>
</html>