...
<body class="font-sans">
    <form action="?action=store-register" method="post"
        class="p-5 mt-rounded-xl shadow-lg max-w-xl m-auto grid grid-cols-2 gap-3 justify-center bg-slate-500">
        ...
        class="col-span-2 p-2 rounded-xl shadow-lg bg-blue-100  font-semibold tracking-wide hover:bg-[var(--primary)] hover:text[var(--accent)] transition-all duration-300">
    </form>
</body>
</html>