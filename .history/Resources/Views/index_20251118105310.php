                ...
                <?php if($_SESSION['user']['role'] === 'admin'): ?>
                    ...
                    <li>
                        <a href="?action=manage-user"
                           class="hover:text-cyan-400 transition">Manage User</a>
                    </li>

                    <li>
                        <a href="?action=manage-tarif"
                           class="hover:text-cyan-400 transition">Manage Tarif</a>
                    </li>

                    <li>
                        <a href="?action=manage-tiket"
                           class="hover:text-cyan-400 transition">Manage Tiket</a>
                    </li>

                    <li>
                        <a href="?action=manage-transaksi"
                           class="hover:text-cyan-400 transition">Manage Transaksi</a>
                    </li>

                <?php elseif($_SESSION['user'] === 'petugas'): ?>

                    <!-- MENU PETUGAS -->
                    <li>
                        <a href="?action=tiket-masuk"
                           class="hover:text-cyan-400 transition">Tiket Masuk</a>
                    </li>

                    <li>
                        <a href="?action=tiket-keluar"
                           class="hover:text-cyan-400 transition">Tiket Keluar</a>
                    </li>

                    <li>
                        <a href="?action=transaksi"
                           class="hover:text-cyan-400 transition">Transaksi</a>
                    </li>
        ...
        <div class="flex gap-6 items-center">
            ...
            <?php if(isset($_SESSION['user'])): ?>
                ...
                <span class="text-slate-300">
                    ...
                    <b class="text-cyan-400">(<?= $_SESSION['role'] ?>)</b>
                </span>
